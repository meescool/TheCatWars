...
public interface attacks {
	...
	public default String hitAttack(int attackSuccess, String attackResult) {
	...
	public default String kickAttack(int attackSuccess, String attackResult) {
	...
	public default String punchAttack(int attackSuccess, String attackResult) {
